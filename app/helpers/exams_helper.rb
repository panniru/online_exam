module ExamsHelper
  ...
  def question_btn_group(exam)
    ...
    links << link_to("Upload Questions", upload_new_exam_multiple_choice_questions_path(exam))
    links << link_to("Show Questions", exam_multiple_choice_questions_path(exam))
  ...
  def descriptive_questions(exam)
    link_to "Descriptive Questions", exam_descriptive_questions_path(exam)
  end
