  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved instruction as @instruction" do
        ...
        post :create, {:instruction => { "description" => "invalid value" }}, valid_session
        assigns(:instruction).should be_a_new(Instruction)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested instruction" do
        ...
        Instruction.any_instance.should_receive(:update).with({ "description" => "MyString" })
        put :update, {:id => instruction.to_param, :instruction => { "description" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the instruction as @instruction" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Instruction.any_instance.stub(:save).and_return(false)
        put :update, {:id => instruction.to_param, :instruction => { "description" => "invalid value" }}, valid_session
        assigns(:instruction).should eq(instruction)
      end
